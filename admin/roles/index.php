                ...
                <tbody>
                  ...
                  foreach ($roles as $role) {
                    ...
                    <tr>
                      ...
                      <td><center><?= $role['nombre_rol']; ?></center></td>
                      <td>
                        <div class="btn-group" role="group" aria-label="Basic example">
                          ...
                          <form action="<?= APP_URL; ?>/app/controllers/roles/delete.php" onclick="preguntar(event, <?= $id_rol; ?>)" method="post" id="miFormulario<?= $id_rol; ?>">
...
<script>
  function preguntar(event, id_rol) {
