...
if (isset($_SESSION['sesion email'])) {
  ...
  $query_sesion = $pdo->prepare("SELECT * FROM usuarios WHERE email = 'admin@admin.com' AND estado = '1'");
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= APP_URL; ?>/admin" class="brand-link">
        <img src="https://cdn-icons-png.flaticon.com/512/3315/3315761.png" alt="AdminLTE Logo"
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= APP_URL; ?>/login" class="nav-link" style="background-color: #eb2d14;color:black">
